        ...
        <div className="card" style={{ padding: 16, border: "2px solid var(--green, #16a34a)" }}>
          ...
          <div className="form-group">
            ...
            <div
              ...
              style={{
                border: `2px dashed ${grnFile ? "var(--blue)" : "var(--border)"}`,
                borderRadius: "var(--radius)", padding: 16, textAlign: "center",
                cursor: "pointer", background: grnFile ? "var(--blue-light,#eff6ff)" : "var(--surface)",
              }}
            >
              {grnFile
                ? <div style={{ fontSize: 13, fontWeight: 600, color: "var(--blue)" }}>📎 {grnFile.name}<br /><span style={{ fontSize: 11, fontWeight: 400, color: "var(--ink-3)" }}>Tap to change</span></div>
                : <div style={{ fontSize: 13, color: "var(--ink-3)" }}>📷 Tap to attach a delivery photo</div>
              }
            </div>
            <input ref={grnFileRef} type="file" accept="image/png,image/jpeg,image/jpg" style={{ display: "none" }}
